...
const productC = require("../controllers/coordinator-controller.js");
const Product = require("../models/Coordinator.js");
const Category = require("../models/Student.js");
...
router.get("/u/a2", async (req, res) => {
  try {
    const getProductsByPrice = await Product.aggregate([
      { $sort: { price: -1 } },
    ]);
